...
<head>
        ...
        <meta charset="utf-8" />
        <title>Oar Infotech User Dashboard</title>
                       ...
                       <!--  <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="" src=""
                                    alt="">
                                <span class="d-none d-xl-inline-block ml-1"><strong>Welcome</strong>   {{Auth::user()->name}}</span>
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/userprofile" class=" waves-effect">
