                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="/sliders/{{$slider->id}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="{{ $slider->slider_upper_description}}" id="example-text-input" name="description01">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">Slider Lower Description </label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="{{ $slider->slider_lower_description}}" id="example-search-input" name="description02">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                              <label for="example-search-input" class="
                                                    col-md-2 col-form-label">Slider Banner</label>
                                                <div class="col-md-10">
