                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <p class="text-muted font-weight-medium">Total Purchases</p>
                                                        <h4 class="mb-0">10</h4>
                                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <p class="text-muted font-weight-medium">Cart</p>
                                                        <h4 class="mb-0">4</h4>
                                                    </div>
                                            ...
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                @foreach($orders as $order)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <i class=" mr-1"></i>{{$order->amount_to_pay}}
                                                        </td>
                                                        <td>{{$order->getBalance($order->total_amount, $order->amount_to_pay)}}</td>
