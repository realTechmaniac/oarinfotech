                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <p class="card-title-desc">The details of all sliders on the frontend are below.
                                        </p>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$key+1}}</td>
                                                <td>{{$slider->slider_upper_description}}</td>
                                                <td>{{$slider->slider_lower_description}}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="row">
                                                            ...
                                                            <div class="col-md-2 ">
                                                                ...
                                                                <a href="/sliders/{{$slider->id}}/edit" class="btn btn-primary waves-effect waves-light ">Edit</a>
                                                            ...
                                                            <form method="POST" action="/sliders/{{$slider->id}}">
                                                                ...
                                                                <div class="col-md-2 ">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light mr-1">Delete</button>
                                                            ...
                                                            <div class="col-md-2 mr-1">
                                                                <a href="/activate/{{$slider->id}}" class="btn btn-success waves-effect waves-light ml-2">Activate</a>
                                                            </div>
