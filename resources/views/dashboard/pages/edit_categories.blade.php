                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Edit the product category Information below</p>
                                    ...
                                    <form method="POST" action="/categories/{{$category->id}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="{{$category->category_name}}" id="example-text-input" name="category_name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
