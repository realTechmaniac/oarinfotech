                        ...
                        <div class="col-md-12">
                            <div class="filter__menu__container">
                                <div class="product__menu">
                                    ...
                                    <a href="{{route('laptops')}}" style="margin-right: 8px;" >LAPTOPS</a>
                                    <a href="{{route('phones')}}" style="margin-right: 8px;" >PHONES</a>
                                    <a href="{{route('laptopaccess')}}" style="margin-right: 8px;" >LAPTOP ACCESSORIES</a>
                                    <a href="{{route('phoneaccess')}}" style="margin-right: 2px;" >PHONE ACCESSORIES</a>
