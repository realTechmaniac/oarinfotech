        ...
        <div class="cart-main-area ptb--120 bg__white">
            <div class="container">
                ...
                @if(Cart::count() > 0 )
                    ...
                    <h2 style="padding-bottom: 15px; ">{{Cart::count() }} Item(s) in the Shopping Cart</h2>
                <div class="row">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td class="product-name"><a href="{{route('products.show', $item->id)}}">{{$item->name}}</a></td>
                ...
                @else
                    <div class="alert alert-danger text-center">
                         ...
                         <h3><strong>No item in the Cart !!</strong></h3>
